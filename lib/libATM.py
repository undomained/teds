...
def get_microHH_atm(s2_lat, s2_lon, path_data, microHH_settings, kernel_settings):
    ...
    transform = libNumTools.TransformCoords(lat_lon_src)
    ...
    for iz in range(data.grid.nz):
        data.conv_co2_m[iz, :, :] = libNumTools.convolution_2d(data.co2_m.conc[iz, :, :], conv_settings)
        data.conv_no[iz, :, :] = libNumTools.convolution_2d(data.no.conc[iz, :, :], conv_settings)
        data.conv_no2[iz, :, :] = libNumTools.convolution_2d(data.no2.conc[iz, :, :], conv_settings)
