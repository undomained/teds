...
def l1al1b_configuration(locations, local_config):     
    ...
    lines.append('l1a_files = '+ locations['l1a_input']+'\n')
    #Location of the level1b data
    lines.append('outputfile = ' + locations['l1b_output']+'\n')
    #location of gm input
    lines.append('geometry_file = ' + locations['gm_input']+'\n')
    ...
    new_config = open(locations['L1AL1B_path']+'l1al1b_config.cfg','w')
