...
def find_dataset(input_data, group_name, dataset_name, data_file_1, data_file_2):
    ...
    log.debug(f"GROUP: {group_name} and dataset: {dataset_name}, var_1: {var_1} and var_2: {var_2}")
...
def compare_data(data_file_1, data_file_2):

    data_1_input = Input_netcdf(data_file_1)
    data_1 = data_1_input.read()
    print(f"DATA_1: {data_1}")
    data_2_input = Input_netcdf(data_file_2)
    ...
    nc_output = dn.DataNetCDF(output_file_name)
...
if __name__ == '__main__' :
    ...
    log.info(f"Comparing files {data_1} and {data_2}")
