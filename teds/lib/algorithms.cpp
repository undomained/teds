// Python interface to various algorithms that can replace Python
// functions in CPU-intensive parts of TEDS.
...
static PyObject* rtACT(PyObject* /* self */, PyObject* args)
{
...
static PyMethodDef algorithms_methods[] = {
    { "cpp_rt_act",
      rtACT,
      METH_VARARGS,
...
static struct PyModuleDef algorithmsmodule = {
    ...
    "algorithms",
    "Python interface for algorithms",
    -1,
    algorithms_methods
};
...
{
    auto py_object { PyModule_Create(&algorithmsmodule) };
    import_array();
    return py_object;
}
